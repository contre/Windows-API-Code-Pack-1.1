...
{
	/// <summary>This class attribute is applied to a Preview Handler to specify registration parameters.</summary>
	...
	public sealed class PreviewHandlerAttribute : Attribute
	{
		...
		/// <summary>Gets the AppId associated with the handler for use with the surrogate host process.</summary>
		public string AppId { get; private set; }

		/// <summary>Disables low integrity-level process isolation. <remarks>This should be avoided as it could be a security risk.</remarks></summary>
		public bool DisableLowILProcessIsolation { get; set; }

		/// <summary>Gets the semi-colon-separated list of extensions supported by the preview handler.</summary>
