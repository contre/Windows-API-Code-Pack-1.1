...
{
    /// <summary>A COM interop wrapper for the ISensorsManager interface</summary>
    ...
    {
        /// <summary>Get a collection of related sensors by category, Ex: Light</summary>
        ...
        /// <summary>Get sensors by type, Ex: Ambient Light</summary>
        ...
        /// <summary>Get a unique instance of a sensor</summary>
        ...
        /// <summary>Subscribe to ISensors events</summary>
        ...
        /// <param name="sensors">
        /// Pointer to the ISensorCollection interface that contains the list of sensors for which permission is being requested
        /// </param>
    ...
    internal class NativeSensorManager : NativeISensorManager
    {
        ...
        public extern virtual HResult GetSensorsByCategory(
            [In, MarshalAs(UnmanagedType.LPStruct)] Guid sensorCategory,
            [Out, MarshalAs(UnmanagedType.Interface)] out ISensorCollection ppSensorsFound);

        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public extern virtual HResult GetSensorsByType(
            [In, MarshalAs(UnmanagedType.LPStruct)] Guid sensorType,
            [Out, MarshalAs(UnmanagedType.Interface)] out ISensorCollection ppSensorsFound);

        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public extern virtual HResult GetSensorByID(
            [In, MarshalAs(UnmanagedType.LPStruct)] Guid sensorID,
            [Out, MarshalAs(UnmanagedType.Interface)] out ISensor ppSensor);

        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public extern virtual void SetEventSink(
            [Out, MarshalAs(UnmanagedType.Interface)] ISensorManagerEvents pEvents);

        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public extern virtual void RequestPermissions(
            IntPtr hParent,
