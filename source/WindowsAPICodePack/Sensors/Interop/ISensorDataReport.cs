...
{
    /// <summary>COM interop wrapper for the ISensorDataReport interface.</summary>
    ...
    internal interface ISensorDataReport
    {
        ...
        /// <summary>Get multiple values reported by a sensor</summary>
    ...
    /// <summary>
    /// The SystemTime structure represents a date and time using individual members for the month, day, year, weekday, hour, minute, second,
    /// and millisecond.
    /// </summary>
    ...
    internal struct SystemTime
    {
        ...
        /// <summary>Gets the <see cref="DateTime"/> representation of this object.</summary>
