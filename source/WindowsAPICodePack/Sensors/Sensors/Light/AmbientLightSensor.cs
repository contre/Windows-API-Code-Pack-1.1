...
{
	/// <summary>Represents a generic ambient light sensor.</summary>
	[SensorDescription("97F115C8-599A-4153-8894-D2D12899918A")]
	public class AmbientLightSensor : Sensor
	{
		/// <summary>Gets the current luminous intensity of the sensor.</summary>
		public LuminousIntensity CurrentLuminousIntensity => new LuminousIntensity(DataReport);

		/// <summary>Gets an array representing the light response curve.</summary>
	...
	/// <summary>Defines a luminous intensity measurement.</summary>
	public class LuminousIntensity
	{
		/// <summary>Initializes a sensor report to obtain a luminous intensity value.</summary>
		...
		/// <summary>Gets the intensity of the light in lumens.</summary>
