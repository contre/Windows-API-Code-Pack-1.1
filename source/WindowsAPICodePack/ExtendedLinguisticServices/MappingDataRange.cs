...
{
	/// <summary>
	/// Contains text recognition results for a recognized text subrange. An array of structures of this type is retrieved by an ELS service
	/// in a <see cref="MappingPropertyBag">MappingPropertyBag</see> structure.
	/// </summary>
	public class MappingDataRange
	{
		...
		/// types are "text/plain", "text/html", and "text/css".
		///
		...
		/// <summary>
		/// Index of the end of the subrange in the text, where 0 indicates the first character at of the string passed to
		/// MappingService.RecognizeText or MappingService.BeginRecognizeText, instead of an offset to the index passed to the function in
		/// the index parameter. The value should be less than the entire length of the text.
		/// </summary>
		public int EndIndex => (int)_win32DataRange._endIndex;

		/// <summary>
		/// Index of the beginning of the subrange in the text, where 0 indicates the first character of the string passed to
		/// MappingService.RecognizeText or MappingService.BeginRecognizeText, instead of an offset to the index passed to the function in
		/// the index parameter. The value should be less than the entire length of the text.
		/// </summary>
		...
		/// supplied in the <see cref="ContentType">ContentType</see> property.
		/// </summary>
		public byte[] GetData()
		{
			var data = new byte[(int)_win32DataRange._dataSize];
