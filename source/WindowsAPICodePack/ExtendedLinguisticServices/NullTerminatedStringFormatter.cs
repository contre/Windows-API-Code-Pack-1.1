...
{
    /// <summary>Converts byte arrays containing Unicode null-terminated strings into .NET string objects.</summary>
    public class NullTerminatedStringFormatter : IMappingFormatter<string>
    {
        ...
        /// <summary>Uses <see cref="Format(MappingDataRange)">Format</see> to format all the ranges of the supplied <see cref="MappingPropertyBag">MappingPropertyBag</see>.</summary>
