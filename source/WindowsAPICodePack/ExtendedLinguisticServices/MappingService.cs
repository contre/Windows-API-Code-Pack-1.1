...
{
    /// <summary>Represents an ELS service. A detailed overview of the Extended Linguistic Services platform is available at: http://msdn.microsoft.com/en-us/library/dd317839(VS.85).aspx</summary>
    public class MappingService
    {
        ...
        /// <summary>
        /// Constructs a new <see cref="MappingService">MappingService</see> object by instanciating an ELS service by its guid. For Windows
        ...
        ///
        /// If the service with the specified guid doesn't exist, a <see cref="LinguisticException">LinguisticException</see> is thrown.
        /// </summary>
        ...
        /// <summary>The service category for the service, for example, "Transliteration".</summary>
        public string Category => _win32Service._category;

        /// <summary>Copyright information about the service.</summary>
        public string Copyright => _win32Service._copyright;

        /// <summary>The service description. This text can be localized.</summary>
        ...
        /// <summary>
        /// Optional. A collection of input content types, following the format of the MIME content types, that identify the format that the
        ...
        /// <summary>
        /// A collection of the input languages, following the IETF naming convention, that the service accepts. This member is set to null
        /// if the service can work with any input language.
        /// </summary>
        ...
        /// <summary>
        /// A collection of input scripts, with Unicode standard script names, that are supported by the service. This member is set to null
        /// if the service can work with any scripts, or if the service ignores the input scripts.
        /// </summary>
        ...
        /// <summary>
        /// Optional. A collection of output content types, following the format of the MIME content types, that identify the format in which
        ...
        /// <summary>
        /// A collection of output languages, following the IETF naming convention, in which the service can retrieve results. This member is
        /// set to null if the service can retrieve results in any language, or if the service ignores the output language.
        /// </summary>
        ...
        /// <summary>
        /// A collection of output scripts supported by the service. This member is set to null if the service can work with any scripts, or
        ...
        /// are shown in the following table. 0 - The input and output languages are not paired and the service can receive data in any of
        /// the input languages and render data in any of the output languages. 1 - The arrays of the input and output languages for the
        /// service are paired. In other words, given a particular input language, the service retrieves results in the paired language
        /// defined in the output language array. Use of the language pairing can be useful, for example, in bilingual dictionary scenarios.
        /// </summary>
        ...
        public static void DoAction(MappingPropertyBag bag, int rangeIndex, string actionId)
        {
            ...
            var hResult = Win32NativeMethods.MappingDoAction(ref bag._win32PropertyBag, (uint)rangeIndex, actionId);
            if (hResult != 0)
            {
                throw new LinguisticException(hResult);
            }
        ...
        /// <summary>Waits for the asynchronous operation to complete.</summary>
        ...
        /// The <see cref="MappingRecognizeAsyncResult">MappingRecognizeAsyncResult</see> object associated with the operation.
        /// </param>
        ...
        /// </summary>
        /// <param name="options">
        /// Optional. A <see cref="MappingEnumOptions">MappingEnumOptions</see> object containing criteria to use during enumeration of
        /// services. The application specifies null for this parameter to retrieve all installed services.
        /// </param>
        /// <returns>
        /// An array of <see cref="MappingService">MappingService</see> objects matching the criteria supplied in the options parameter.
        /// </returns>
        ...
        /// <summary>
        /// Calls an ELS service to recognize text. For example, the Microsoft Language Detection service will attempt to recognize the
        /// language in which the input text is written. The execution will be handled in a thread from the managed thread pool, and the
        /// asynchronous wait handle of the returned <see cref="MappingRecognizeAsyncResult">MappingRecognizeAsyncResult</see> object will be
        /// notified when the operation completes. The results of the call will be stored inside the
        /// <see cref="MappingRecognizeAsyncResult">MappingRecognizeAsyncResult</see> object.
        /// </summary>
        /// <param name="text">
        /// The text to recognize. The text must be UTF-16, but some services have additional requirements for the input format. This
        /// parameter cannot be set to null.
        /// </param>
        /// <param name="options">
        /// Optional. A <see cref="MappingOptions">MappingOptions</see> object containing options that affect the result and behavior of text
        /// recognition. The application does not have to specify values for all object members. This parameter can be set to null to use the
        /// default mapping options.
        /// </param>
        /// <param name="asyncCallback">
        /// An application callback delegate to receive callbacks with the results from the recognize operation. Cannot be set to null.
        /// </param>
        /// <param name="callerData">
        /// Optional. Private application object passed to the callback function by a service after text recognition is complete. The
        /// application must set this parameter to null to indicate no private application data.
        /// </param>
        ...
        /// <param name="index">
        /// Index inside the specified text to be used by the service. This value should be between 0 and length-1. If the application wants
        /// to process the entire text, it should set this parameter to 0.
        /// </param>
        /// <param name="options">
        /// Optional. A <see cref="MappingOptions">MappingOptions</see> object containing options that affect the result and behavior of text
        /// recognition. The application does not have to specify values for all object members. This parameter can be set to null to use the
        ...
        /// </param>
        /// <returns>
        /// A <see cref="MappingPropertyBag">MappingPropertyBag</see> object in which the service has stored its results. The structure is
        /// filled with information produced by the service during text recognition.
        /// </returns>
