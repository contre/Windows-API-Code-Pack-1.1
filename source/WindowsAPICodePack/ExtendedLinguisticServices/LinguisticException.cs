...
{
    /// <summary>
    /// This exception is thrown by the managed wrappers of ELS when the underlying unmanaged implementation returns an HResult which is not
    /// S_OK (0). This exception is also thrown when the managed wrapper detects an exceptional condition which causes it to fail. Please
    ...
    public class LinguisticException : Win32Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinguisticException">LinguisticException</see> class with the last Win32 error that occurred.
        /// </summary>
        public LinguisticException() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="LinguisticException">LinguisticException</see> class with the specified detailed description.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinguisticException">LinguisticException</see> class with the specified detailed
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinguisticException">LinguisticException</see> class with the specified context and
