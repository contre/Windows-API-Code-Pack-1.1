...
namespace Microsoft.WindowsAPICodePack.ApplicationServices
{
	...
	public static class ApplicationRestartRecoveryManager
	{
		...
		/// <remarks>
		/// This should be the last call made by the <see cref="RecoveryCallback"/> method because Windows Error Reporting will terminate the
		...
		public static bool ApplicationRecoveryInProgress()
		{
			...
			var hr = AppRestartRecoveryNativeMethods.ApplicationRecoveryInProgress(out var canceled);
		...
		/// <see cref="ApplicationRecoveryInProgress"/> method to indicate that it is still performing recovery work.
		/// </remarks>
