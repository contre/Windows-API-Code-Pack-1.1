...
namespace Microsoft.WindowsAPICodePack.ApplicationServices
{
	...
	internal static class EventManager
	{
		...
		// Prevents reading from PowerManager members while they are still null. MessageManager notifies the PowerManager that the member has
		...
		// Used to catch the initial message Windows sends when you first register for a power notification. We do not want to fire any event
		// handlers when this happens.
