...
namespace Microsoft.WindowsAPICodePack.Dialogs
{
    ...
    public abstract class DialogControl
    {
        ...
        public string Name
        {
            ...
            set
            {
                // Names for controls need to be quite stable, as we are going to maintain a mapping between the names and the underlying
                // Win32/COM control IDs.
                ...
                // Note that we don't notify the hosting dialog of the change, as the initial set of name is (must be) always legal, and
                // renames are always illegal.
                name = value;
            }
        }
